...
CONFIG = [
    ...
    },
    {
        ...
        'directory': 'Body',
        'required': True,
        'rarity_weights': [10, 10, 20, 20, 20, 20, 30, 30, 30, 30, 30, 30, 30, 30, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40],
    },
    {
        'id': 4,
        'name': 'face',
    ...
    },
    {
        ...
        'directory': 'Head',
        'required': False,
        'rarity_weights': [40, 10, 10, 20, 20, 20, 30, 30, 30, 30, 30, 30, 30, 40, 40, 40, 40, 40, 40, 40, 40],
    },
    {
        'id': 7,
        'name': 'face_mask',
